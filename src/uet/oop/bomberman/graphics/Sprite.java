...
public class Sprite {
	...
	public static Sprite[] ex_vertical = {explosion_vertical, explosion_vertical1, explosion_vertical2};
	...
	public static Sprite[] ex_horizontal = {explosion_horizontal, explosion_horizontal1, explosion_horizontal2};
